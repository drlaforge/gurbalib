...
void setup(){
   ...
   set_long_f("You stand in the wilderness, to the north is the edge of Fresad Jungle and to the south "+
      ...
      "To the and northeast the road fades, nothing much must travel past the jungle that stands there. "+
      "To the south a road extends...more of a dirt path actually. Any thoughts of traveling by foot "+
      "quickly fade. Far off to the west you see the outlines of a mountain range, and to the south the dark "+
   ...
   add_item(({"road", "west road", "east road", "dirt road", "dusty road", "dirt path"}),
      "A worn down dusty road that runs west to east from here");
