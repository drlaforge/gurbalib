...
stone->set_weight(100);
    ...
    dest_dir = ({
        "/room/cemetary/d4", "west",
        "/room/cemetary/d6", "east",
        });
    items = ({
          });
}
...
write("You cant move it.\n");
write("You carry to much.\n");
say(this_player()->query_name()+" pushes on the stone, but cant move it.\n");
return 1;
}
write("Ok.\n");
