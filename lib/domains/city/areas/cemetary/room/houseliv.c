...
items = ({
    ...
    dest_dir = 
        ({
        "/domains/areas/city/cemetary/room/housekitch", "north",
        "/domains/areas/city/cemetary/room/house", "east",
        });
}
...
get(str){
	...
	batt = 1;
move_object(clone_object("/domains/areas/city/cemetary/obj/batteries"),this_player());
