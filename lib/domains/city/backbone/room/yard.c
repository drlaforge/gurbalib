...
void setup() {
    ...
    items_arr = ({
         ({"central square","square"}), "It is to the south",
         "pub", "The pub looks open and inviting",
         ({"eve street","street"}), "Yes, this is Eve street",
	 ({"lights","flashing lights","casino"}),
	 "Could be a casino or something, better go take a look",
	 ({"smell","bacon"}),"It definitly smells like bacon",
	});

      dest_dir = ({ ROOM+"west_square1", "south",
	          ROOM+"pub", "west",
              ROOM+"eve_street1","north" });
