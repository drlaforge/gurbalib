...
int showCmds(){
   ...
   printf("%-15s%-62s\n%-15s%-62s\n\n%-15s%-62s\n%-15s%-62s\n\n%-15s%-62s\n%-15s%-62s\n\n",
      ...
      "printout", "Comprehensive printout of your finances with ACB.",
...
int checkLoan(string which){
   ...
   if(!foo || (foo && !m_sizeof(foo)))
      out = "You have no loans. Currently ACB is offering great rates, come in today!\n";
