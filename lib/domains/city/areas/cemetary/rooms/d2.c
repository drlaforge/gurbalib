...
reset(arg) {
	...
	+ "to continue to the south and to the east.\n"
	+ "There is a ladder leading up here.\n";
    dest_dir = ({
        "/domains/areas/city/cemetary/room/d1", "up",
	"/domains/areas/city/cemetary/room/d4", "east",
        "/domains/areas/city/cemetary/room/d3", "south",
        });
    items = ({
      "ladder","The ladder leads out of the mines",
          });
}
